                    ...
                    <div className = "flex flex-wrap items-center md:justify-between justify-center" >
                        <div className = "w-full md:w-4/12 px-4" >
                            <div className = "text-sm text-blueGray-500 font-semibold py-1 text-center md:text-left" >Copyright© { new Date().getFullYear() } { " " } 
                                <a href = "https://iteam-s.mg/"className = "text-white hover:text-blueGray-300 text-sm font-semibold py-1" >iTeam-$ </a> 
                            </div> 
                        </div> 
                        <div className = "w-full md:w-8/12 px-4" >
                            <ul className = "flex flex-wrap list-none md:justify-end  justify-center" >
                                ...
                                <li>
                                    <a href = "https://iteam-s.mg/view/membre.html" target="_blank" rel="noreferrer" className = "text-white hover:text-blueGray-300 text-sm font-semibold block py-1 px-3" >About Us </a> 
                                </li> 
                                <li >
