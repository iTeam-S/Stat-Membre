...
export default function Landing() {
    return ( <
        ...
        Les équipes dans Iteam - $. <
        /h1> <
        p className = "mt-4 text-lg text-blueGray-200" >
        Vous pouvez voir ici tous les développeurs chez Iteam - $ avec leur compétences, projets en cours. <
        /p> <
        /div> <
        /div> <
        /div> <
        ...
        div className = "mt-6" >
        <
        button className = "bg-lightBlue-400 text-white w-8 h-8 rounded-full outline-none focus:outline-none mr-1 mb-1"
        type = "button" >
        <
        i className = "fab fa-twitter" > < /i> <
        /button> <
        button className = "bg-lightBlue-600 text-white w-8 h-8 rounded-full outline-none focus:outline-none mr-1 mb-1"
        type = "button" >
        <
        ...
        div className = "mt-6" >
        <
        button className = "bg-red-600 text-white w-8 h-8 rounded-full outline-none focus:outline-none mr-1 mb-1"
        type = "button" >
        <
        ...
        i className = "fab fa-twitter" > < /i> <
        /button> <
        button className = "bg-blueGray-700 text-white w-8 h-8 rounded-full outline-none focus:outline-none mr-1 mb-1"
        type = "button" >
        <
        ...
        y = "0" >
        <
        polygon className = "text-blueGray-800 fill-current"
        points = "2560 0 2560 100 0 100" >
        < /polygon> <
        /svg> <
        /div>
