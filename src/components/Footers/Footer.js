...
export default function Footer() {
    return ( <
        ...
        type = "button" > < i className = "fab fa-twitter" > < /i> </button >
        ...
        type = "button" > < i className = "fab fa-facebook-square" > < /i> </button >
        ...
        type = "button" > < i className = "fab fa-github" > < /i> </button >
        <
        /div>  <
        /div>  <
        div className = "w-full lg:w-6/12 px-4" >
        ...
        <
        li > < a className = "text-blueGray-600 hover:text-blueGray-800 font-semibold block pb-2 text-sm"
        href = "https://iteams.mg" > About Us < /a></li >

        <
        li > < a className = "text-blueGray-600 hover:text-blueGray-800 font-semibold block pb-2 text-sm"
        href = "https://iteams.mg" > Page < /a> </li >

        <
        li > < a className = "text-blueGray-600 hover:text-blueGray-800 font-semibold block pb-2 text-sm"
        href = "https://iteams.mg" > Github < /a> </li >

        <
        li > < a className = "text-blueGray-600 hover:text-blueGray-800 font-semibold block pb-2 text-sm"
        href = "https://iteams.mg" > Products < /a> </li >
        <
        /ul>  <
        /div>  <
        ...
        <
        li > < a className = "text-blueGray-600 hover:text-blueGray-800 font-semibold block pb-2 text-sm"
        href = "https://iteams.mg" > Contact Us < /a> </li >
        <
        /ul>  <
        /div>  <
        /div>  <
        ...
        by { " " } < a href = "https://iteams.mg"
        className = "text-blueGray-500 hover:text-blueGray-800" > Iteam - $ < /a> <
        /div>  <
        /div>  <
        /div>  <
        /div>  <
